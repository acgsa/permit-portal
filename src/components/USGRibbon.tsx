...
export function USGRibbon() {
  ...
  // Only render the ribbon on public logged-out screens.
  ...
  if (token || !isPublicLoggedOutRoute) {
    return null;
  }
