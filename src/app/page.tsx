...
export default function Home() {
  return (
    <>
        ...
        <div className="relative mx-auto h-[min(90vh,580px)] w-full flex items-end justify-center px-2 sm:px-0">
          <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 text-center" style={{ paddingBottom: 'var(--space-3xl)' }}>
            <CyclingHeadline
              ...
              className="mb-8 whitespace-normal md:whitespace-nowrap font-[var(--font-primary)] !text-[clamp(2.35rem,6.4vw,5.9rem)] !font-normal !leading-[1.05] text-[var(--color-text-inverse)]"
            />
          </div>
        </div>
      </section>

      <section className="flex justify-center bg-black text-[var(--color-text-inverse)] px-2 sm:px-6 lg:px-8" style={{ paddingTop: 'var(--space-2xl)', paddingBottom: 'var(--space-3xl)' }}>
        <div className="w-full max-w-7xl flex flex-col items-center gap-8 text-center" style={{ marginLeft: 'clamp(var(--space-sm), 5vw, var(--space-lg))', marginRight: 'clamp(var(--space-sm), 5vw, var(--space-lg))' }}>
          ...
          <h2 className="type-heading-h3 max-w-3xl text-[var(--color-text-inverse)]">
      ...
      {/* Use Cases Section */}
      <section className="flex justify-center bg-black text-[var(--color-text-inverse)] px-2 sm:px-6 lg:px-8" style={{ paddingTop: 'var(--space-3xl)', paddingBottom: 'var(--space-3xl)' }}>
        <div className="w-full max-w-7xl" style={{ marginLeft: 'clamp(var(--space-sm), 5vw, var(--space-lg))', marginRight: 'clamp(var(--space-sm), 5vw, var(--space-lg))' }}>
          <div className="mb-10">
            ...
            <h2 className="type-heading-h3 text-[var(--color-text-inverse)]" style={{ marginBottom: 'var(--space-xl)' }}>High-Demand Federal Permits</h2>
          </div>
            ...
            {useCases.map((useCase, index) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 bg-transparent" style={{ padding: 'var(--space-md)' }}>
                  <h3 className="type-heading-h6 text-[var(--color-text-inverse)]" style={{ marginBottom: 'var(--space-2xs)' }}>{useCase.title}</h3>
                  <div
                  ...
                  >
                    <p className="type-body-sm" style={{ marginRight: 'var(--space-sm)', color: 'var(--color-text-inverse)' }}>{useCase.subhead}</p>
                    <span
                      aria-hidden="true"
                      className="type-heading-h6 shrink-0 text-[var(--color-text-inverse)] transition-transform duration-300 group-hover:translate-x-0.5 group-focus-within:translate-x-0.5"
      ...
      {/* Operations Section */}
      <section className="flex justify-center bg-[#0a0b0d] text-[var(--color-text-inverse)] px-2 sm:px-6 lg:px-8" style={{ paddingTop: 'var(--space-2xl)', paddingBottom: 'var(--space-2xl)' }}>
        <div className="w-full max-w-7xl" style={{ marginLeft: 'clamp(var(--space-sm), 5vw, var(--space-lg))', marginRight: 'clamp(var(--space-sm), 5vw, var(--space-lg))' }}>
          <div className="max-w-6xl">
            <h3 className="font-[var(--font-primary)] text-[clamp(1.8rem,4.4vw,4rem)] font-normal leading-[1.1] text-[var(--color-text-inverse)]" style={{ marginBottom: 'var(--space-xl)' }}>
